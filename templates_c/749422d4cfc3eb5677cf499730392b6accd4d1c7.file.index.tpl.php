...
<?php /*%%SmartyHeaderCode:10120501c9cd10f05d2-64353719%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '10120501c9cd10f05d2-64353719',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_501c9cd1169c24_95100737',
  'variables' => 
  array (
    'name' => 0,
    'photo_ses' => 0,
...
<?php if ($_valid && !is_callable('content_501c9cd1169c24_95100737')) {function content_501c9cd1169c24_95100737($_smarty_tpl) {?><!doctype html>
...
<body id="top">
  ...
  <div id="container">
    ...
    <div id="header-surround"><header id="header">
		...
		<div id="user-info">
			<p>
				<span class="messages">Hello <b><?php echo $_smarty_tpl->tpl_vars['name']->value;?>
</b> </span>
    ...
    <aside id="sidebar">
		...
		<section id="login-details">
			<?php if ($_smarty_tpl->tpl_vars['photo_ses']->value!=''){?>
    			<img class="img-left framed" src="img/photo/<?php echo $_smarty_tpl->tpl_vars['photo_ses']->value;?>
" alt="Hello Admin" width="80">
    		<?php }else{ ?>
    		...
    		<h2><a class="user-button" href="javascript:void(0);">
    			<?php if ($_smarty_tpl->tpl_vars['level']->value=='Administrator'){?>
    			Administrator
    			<?php }else{ ?>
    			Sales
    			<?php }?>
